...
function(_unigraph_generate_report)
    ...
    foreach (unit IN LISTS unit_list)
        ...
        _unigraph_json_append_list(${json_content} "test_sources" "${indent}" 4 target_test_sources NO json_content)
        _unigraph_json_append_list(${json_content} "properties" "${indent}" 4 target_properties YES json_content)
