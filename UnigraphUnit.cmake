...
function(unigraph_unit unit_name)
    ...
    # Parse unit sources, taking into account platform annotations
    set(target_sources)
	...
	if (source MATCHES "^:([a-zA-Z0-9_\\-]+)(:([a-zA-Z0-9_\\-]+))*$")
	  ...
	  string(REGEX MATCHALL "([a-zA-Z0-9_\\-]+)" platforms ${source})
	  set(use_source FALSE)
	...
	elseif (use_source)
      ...
      endforeach ()
      list(TRANSFORM target_sources PREPEND "${_UNIGRAPH_CURRENT_UNIT_DIRECTORY}/")
    endif ()
    ...
    _unigraph_set_value_to_dict(LIST unit "sources" "${target_sources}")
